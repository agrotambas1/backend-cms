...
import {
  ...
  updateCapability,
  deleteCapability,
} from "../../../controllers/cms/capabilities/capabilityController";

const router = express.Router();

router.use(authMiddleware);

router.get("/capabilities", adminOnly, getCapabilities);

router.get("/capabilities/:id", adminOnly, getCapabilityById);

router.post("/capabilities", adminOnly, createCapability);

router.put("/capabilities/:id", adminOnly, updateCapability);

router.delete("/capabilities/:id", adminOnly, deleteCapability);
