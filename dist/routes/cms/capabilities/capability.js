...
const capabilityController_1 = require("../../../controllers/cms/capabilities/capabilityController");
const router = express_1.default.Router();
router.use(authMiddleware_1.authMiddleware);
router.get("/capabilities", permission_1.adminOnly, capabilityController_1.getCapabilities);
router.get("/capabilities/:id", permission_1.adminOnly, capabilityController_1.getCapabilityById);
router.post("/capabilities", permission_1.adminOnly, capabilityController_1.createCapability);
router.put("/capabilities/:id", permission_1.adminOnly, capabilityController_1.updateCapability);
router.delete("/capabilities/:id", permission_1.adminOnly, capabilityController_1.deleteCapability);
